...
<%
	...
	if(memberDAO.getMemberEmailChecked(memberID) == false) {
		...
		request.getSession().setAttribute("messageContent", "이메일 인증이 필요합니다.");
	}
...
<head>
	...
	<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(result) {
					if(result == -1) {
						...
						var profile = data.memberProfile;
						getFriend(memberID, profile);
					}
		...
		function getFriend(findID, memberProfile){
			 $('#friendResult').html('<thead>' +
				...
				'<img class="media-object img-circle" style="max-width: 300px; margin: 0px auto;" src="' + memberProfile + '">' +
				'<h3>' + findID + '</h3><a href="chat.jsp?toID=' + 
...
<body>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				<tr>
					<td style="width: 110px;background-color: #006DCC; color: white; text-align: center;"><h5>친구 아이디</h5></td>
