		...
		<form method="post" action="./boardWrite" enctype="multipart/form-data">
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<th style="width: 110px; background-color: #006DCC; color: white; text-align: center;"><h5>글 제목</h5></th>
						<td><input class="form-control" type="text" name="boardTitle" placeholder="글 제목을 입력하세요." maxlength="50"></td>
					</tr>
					<tr>
						<th style="width: 110px; background-color: #006DCC; color: white; text-align: center;"><h5>글 내용</h5></th>
						<td><textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글 내용을 입력하세요"></textarea></td>
					</tr>
					<tr>
						<th style="width: 110px;background-color: #006DCC; color: white; text-align: center;"><h5>파일 업로드</h5></th>
						<td colspan="2">
